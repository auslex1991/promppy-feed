...
export const getReactionsFor = impl.getReactionsFor;
export const addPushSubscription = impl.addPushSubscription;
export const deletePushSubscription = impl.deletePushSubscription;
export const getPushSubscriptions = impl.getPushSubscriptions;
export const getActiveSponsor = impl.getActiveSponsor;
export const setSponsor = impl.setSponsor;
...
export const removeXAccount = impl.removeXAccount;
